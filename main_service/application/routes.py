...
def randomMovie():
    ...
    random_movies=requests.get('http://projects_random_master_1:5000/randomMaster',currentuser)
    ...
    return render_template('randomMovie.html', title='randomMovie', randommovies= resultrandom_movies)
